                      ...
                      var fbs = function() {
                          ...
                          function renderLikeButton() {
                              if (!scope.fbshare && !watchAdded) {
                                  ...
                                  element.html('<div class="fb-share-button" data-href="' + scope.fbshare + '" data-layout="button_count" style="position: relative; top: 50%; transform: translateY(-10%);"></div>');
                                  $window.FB.XFBML.parse(element.parent()[0]);
                              }
                          }
                      }
                  ...
                  link: function (scope, element, attrs) {
                      ...
                      function renderTweetButton() {
                          if (!scope.tweet && !watchAdded) {
                              ...
                              element.html('<a class="twitter-share-button" data-size="medium" href="https://twitter.com/intent/tweet?text='+scope.tweet+'&hashtags='+scope.hashTagTweet+',DevCafe&url='+(scope.tweetUrl || $location.absUrl())+'">Tweet</a>');
